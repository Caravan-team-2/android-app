package smartcaravans.constat.client.settings.data
...
class SettingsDataStore(private val context: Context) {
    ...
    val theme = dataFlow(context.dataStore, THEME_KEY, Theme.LIGHT.name)
        .map { themeName -> Theme.fromString(themeName) }
    val colorTheme = dataFlow(context.dataStore, COLOR_THEME_KEY, ColorScheme.BLUE.name)
